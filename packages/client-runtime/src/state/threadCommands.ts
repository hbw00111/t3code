...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    getGoal: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:get-goal",
      execute: (input: GetThreadGoalInput) => getThreadGoal(input),
      scheduler,
      concurrency,
    }),
