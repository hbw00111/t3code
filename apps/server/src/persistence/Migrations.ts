...
import Migration0041 from "./Migrations/041_ProjectionThreadsGoal.ts";
import Migration0042 from "./Migrations/042_ProjectionThreadsGoalSyncWatermark.ts";
...
export const migrationEntries = [
  ...
  [41, "ProjectionThreadsGoal", Migration0041],
  [42, "ProjectionThreadsGoalSyncWatermark", Migration0042],
] as const;
